note
	...
	description:
		...
		"Test worker that repeatedly reads a file using one encoding."

	author: "samedit66 <samedit66@yandex.ru>"
	library: "os"

class OS_FILE_PATH_ENCODING_READER
...
feature {NONE} -- Initialization
	...
	make (a_file: OS_FILE_PATH; a_encoding: ENCODING; a_expected_text: READABLE_STRING_GENERAL)
